...
CREATE TABLE IF NOT EXISTS orders (
    ...
    UNIQUE KEY uk_orders_line_group_id (line_group_id),
...
CREATE TABLE IF NOT EXISTS line_tasks (
    ...
    task_type VARCHAR(50) NOT NULL DEFAULT 'line_push' COMMENT 'line_push/line_push_messages/rag_reply/rich_menu_link/rich_menu_unlink/order_group_invite',
